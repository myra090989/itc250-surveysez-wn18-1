<?php
/**
 * survey_view.php along with index.php provides a List/View application for the SurveySez project
 * 
 * @package SurveySEz
 * @author Mai Sarmiento <myra.sarmiento@seattlecentral.edu>
 * @version 0.1
 * @link http://www.maisarmiento.xyz/
...
<p>DateAdded ' . $mySurvey->DateAdded . '<p>
';
}else{//no such survey!
 echo '   
...
class Survey
{
  ...
  public $IsValid = false; 
    ...
    public function __construct($myID)
    {
        ...
        $sql = "select Title, Description, DateAdded from wn18_surveys where SurveyID = " . 
        $this->SurveyID;
